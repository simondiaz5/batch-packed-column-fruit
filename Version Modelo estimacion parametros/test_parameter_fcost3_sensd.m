function test_parameter_fcost3d(x_opt,index_140, index_200, index_250)
...
big_titles={'Mcp','Phi mass','Phi heat','Q loss','Boiler Ethanol'};
...
for ip=1:5 % graficar los 5 paràmetros
       for i=1:length(dist_index)
            subplot(2,5,va(ip))
                ...
                plot(dist_exp{i}(20:end,2)/60,dist_model_sobre{i,ip}(20:end,1),'Linewidth',lw3,'Color',[0.85 0 0]); hold on
                plot(dist_exp{i}(20:end,2)/60,dist_model{1,i}(20:end,1),'Linewidth',lw2,'Color','k'); hold on
                plot(dist_exp{i}(20:end,2)/60,dist_model_bajo{i,ip}(20:end,1),'Linewidth',lw3,'Color',[0.55 0 0])
            ...
            subplot(2,5,vb(ip))
                ...
                plot(dist_exp{i}(20:end,2)/60,dist_model_sobre{i,ip}(20:end,8),'Linewidth',lw3,'Color',[0.85 0 0]); hold on
                plot(dist_exp{i}(20:end,2)/60,dist_model{1,i}(20:end,8),'Linewidth',lw2,'Color','k'); hold on
                plot(dist_exp{i}(20:end,2)/60,dist_model_bajo{i,ip}(20:end,8),'Linewidth',lw3,'Color',[0.55 0 0])
